...
class MBReader(mayaiff.IFFReader):
    """Read Maya binary files and call an appropriate handler for each chunk.
    ...
    def __init__(self):
        mayaiff.IFFReader.__init__(self, "Maya")
